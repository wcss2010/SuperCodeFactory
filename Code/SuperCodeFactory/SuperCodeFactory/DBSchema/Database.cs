...
using SuperCodeFactory.DBSchema.DbSchemaProvider;
using SuperCodeFactory.DBSchema.SchemaObject;
using SuperCodeFactory.DBSchema.Mapping;
using SuperCodeFactoryLib.Extensions;
...
namespace SuperCodeFactory.DBSchema
{
    ...
    public abstract class Database
    {
        ...
        int DoUpdateDataSet(UpdateBehavior behavior, DataSet dataSet, string tableName, IDbCommand insertCommand, IDbCommand updateCommand, IDbCommand deleteCommand, int? updateBatchSize)
        {
            ...
            {
                throw new ArgumentException(SuperCodeFactory.Properties.Resources.MustInitAtLeastOneCommand);
            }
        ...
        public virtual DbCommand GetStoredProcCommand(string storedProcedureName, params object[] parameterValues)
        {
            ...
            {
                throw new InvalidOperationException(SuperCodeFactory.Properties.Resources.ParameterMatchFailure);
            }
