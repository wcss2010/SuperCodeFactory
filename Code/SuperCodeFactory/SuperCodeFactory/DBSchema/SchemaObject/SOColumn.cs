...
namespace SuperCodeFactory.DBSchema.SchemaObject
{
    /// <summary>
    /// 列架构对象
    /// </summary>
    ...
    public class SOColumn : SOBase
    {
        ...
        public Type Type
        {
            get
            {
                return SuperCodeFactoryLib.Utilities.TypeUtil.DbType2Type(DataType);
            }
        }
        ...
        public string TypeString
        {
            get
            {
                return SuperCodeFactoryLib.Utilities.TypeUtil.DbType2TypeString(DataType);
            }
        }
