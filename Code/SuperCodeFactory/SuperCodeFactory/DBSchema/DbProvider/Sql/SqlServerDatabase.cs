...
namespace SuperCodeFactory.DBSchema.DbProvider
{
    public class SqlServerDatabase : Database
	{
		...
		private static SqlCommand CheckIfSqlCommand(DbCommand command)
		{
            ...
            if (sqlCommand == null) throw new ArgumentException(SuperCodeFactory.Properties.Resources.CommandNotSqlCommand, "command");
			return sqlCommand;
		}
        ...
        private void OnSqlRowUpdated(object sender, SqlRowUpdatedEventArgs rowThatCouldNotBeWritten)
		{
			if (rowThatCouldNotBeWritten.RecordsAffected == 0)
			{
				...
				{
                    rowThatCouldNotBeWritten.Row.RowError = SuperCodeFactory.Properties.Resources.RowUpdateFailed;
