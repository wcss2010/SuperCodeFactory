...
// SuperCodeFactoryLib Create by 2010-03-09
namespace SuperCodeFactoryLib.Security
{
    /// <summary>
    /// 对称加密算法
    /// </summary>
    public class SymmetricCryto
    {
        ...
        string _Key = "SuperCodeFactoryLib.Security";
        string _IV = "SuperCodeFactoryLib.Security";
